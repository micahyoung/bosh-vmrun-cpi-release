...
var _ = Describe("Config", func() {
	It("runs the cpi", func() {
		...
		config_content := `{"cloud":{"plugin":"vsphere","properties":{"vmrun":{"vm_store_path":"/store-dir","vmrun_bin_path":"/vmrun-bin","ovftool_bin_path":"/ovftool-bin","vdiskmanager_bin_path":"/vdiskmanager-bin","vm_soft_shutdown_max_wait_seconds":20,"vm_start_max_wait_seconds":10},"agent":{"ntp":["time1.google.com","time2.google.com","time3.google.com","time4.google.com"],"blobstore":{"provider":"local","options":{"blobstore_path":"/var/vcap/micro_bosh/data/cache"}},"mbus":"https://mbus:mbuspassword@0.0.0.0:6868"}}}}`
